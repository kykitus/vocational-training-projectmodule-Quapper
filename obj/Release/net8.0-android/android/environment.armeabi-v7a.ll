...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 69469891, ; hash 0x42406c3, from name: Quapper.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 147246739, ; hash 0x8c6ce93, from name: aot-Quapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	...
	%struct.DSOCacheEntry {
		i64 2076752816, ; hash 0x7bc8bbb0, from name: aot-Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 223
	...
	%struct.DSOCacheEntry {
		i64 2822364642, ; hash 0xa839dde2, from name: Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 3485546050, ; hash 0xcfc13642, from name: libaot-Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 3517175126, ; hash 0xd1a3d556, from name: libaot-Quapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
