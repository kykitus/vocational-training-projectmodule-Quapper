...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670644, ; uint32_t jnienv_initialize_method_token (0x6001cb4)
	i32 100670643, ; uint32_t jnienv_registerjninatives_method_token (0x6001cb3)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 900396472720312084, ; hash 0xc7ed9d249824714, from name: Quapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4186382224702142592, ; hash 0x3a190473f5617880, from name: aot-Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 8475680506101537965, ; hash 0x759faa83a3e29cad, from name: Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 15400499529856991723, ; hash 0xd5b990ba20b241eb, from name: libaot-Quapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 400
	...
	%struct.DSOCacheEntry {
		i64 16860107782174144523, ; hash 0xe9fb22b2ff49f80b, from name: aot-Quapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
	...
	%struct.DSOCacheEntry {
		i64 17851814354791216869, ; hash 0xf7be62929d8cb6e5, from name: libaot-Quapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Quapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 459
...
@.env.3 = private unnamed_addr constant [37 x i8] c"174b060c-f90d-446c-ab19-70c4f64114a7\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [18 x i8] c"com.kitus.quapper\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Quapper.dll.so\00", align 16
